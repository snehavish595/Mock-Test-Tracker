...
import { Shield, LayoutDashboard, Database, Sun, Moon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-darkBg text-slate-900 dark:text-slate-100 transition-colors duration-200 flex">
      ...
      <aside className="w-64 bg-white dark:bg-darkCard border-r border-gray-100 dark:border-gray-800 hidden md:flex flex-col justify-between p-6">
        <div className="space-y-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-extrabold text-lg tracking-tight bg-gradient-to-r from-blue-600 to-indigo-500 dark:from-blue-400 dark:to-indigo-300 bg-clip-text text-transparent">RankFlow</h1>
              <p className="text-xs font-semibold text-gray-400 tracking-wider uppercase">IBPS SO Engine</p>
            </div>
          </div>

          <nav className="space-y-1">
            <a href="#dashboard" className="flex items-center gap-3 px-4 py-3 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-xl text-sm font-semibold transition-all">
      ...
      <main className="flex-1 max-h-screen overflow-y-auto px-4 md:px-8 py-6 space-y-6">
        ...
        <header className="flex justify-between items-center bg-white dark:bg-darkCard px-6 py-4 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
          <div>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white">Mock Test Insights Tracker</h2>
        ...
        {/* Global Dashboard Cards Analytics Widget */}
        <Dashboard tests={tests} />

        {/* Unified Input Engine Grid Split Interface */}
        ...
        {/* Recharts Graphical Visualizations Platform Block */}
